<?php
$queryAdmin = "SELECT * FROM user WHERE id_position = 3";
...
<main>
    <div class="content-box">
        ...
        <form action="index.php?action=clients&&delete-all" method="POST">
            <div class="box-btn">
                <a href="index.php?action=add-clients" class="add">
                    <button type="button">
                        Thêm Khách hàng

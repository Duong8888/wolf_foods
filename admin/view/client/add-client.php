...
if (isset($_POST['add-client'])) {
    ...
    if (empty($erro)) {
        $queryAdd = "INSERT INTO user(username,email,password,avatar,id_position) VALUE ('$username','$email','$password','$avatar','3')";
        connect($queryAdd);
...
<main>
    <div class="content-box">
        <p class="title">Thêm Khác Hàng</p>
        <form action="index.php?action=add-clients" class="form-add" method="POST" enctype="multipart/form-data">
            <div class="form-left">
            ...
            <div class="form-bottom">
                <button type="submit" name="add-client" class="btn-form">Thêm Nhân viên<span></span></button>
            </div>
        </form>
    </div>
</main>